				...
				<ul class="layui-nav layui-nav-tree" >
					<li class="layui-nav-item layui-nav-itemed">
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" 
								data-url="${pageContext.request.contextPath}/Info/selectAll"
								class="site-demo-active">翼支付信息管理</a>
							</dd>
							<%--<dd>
								<a href="javascript:;" 
								data-url="${pageContext.request.contextPath}/teacher?method=selectByPage&pageNo=1&pageSize=5"
								class="site-demo-active">教师管理</a>
							</dd>
							<dd>
								<a href="javascript:;"
								   data-url="${pageContext.request.contextPath}/u?method=selectByPage"
